...
if [[ ${VERSION_ID} -eq 37 && $( sudo dnf info --installed mesa-libGL | grep -c '22.3.6-wsl_2' ) == 0 ]]; then
  ...
  sudo dnf -y install --allowerasing --nogpgcheck mesa-dri-drivers-22.3.6-wsl_2 mesa-libGL-22.3.6-wsl_2 mesa-va-drivers-22.3.6-wsl_2 mesa-vdpau-drivers-22.3.6-wsl_2 glx-utils vdpauinfo libva-utils
