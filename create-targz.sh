...
dnf -y install --allowerasing --nogpgcheck mesa-dri-drivers-23.0.2-wsl mesa-libGL-23.0.2-wsl mesa-va-drivers-23.0.2-wsl mesa-vdpau-drivers-23.0.2-wsl glx-utils vdpauinfo libva-utils
